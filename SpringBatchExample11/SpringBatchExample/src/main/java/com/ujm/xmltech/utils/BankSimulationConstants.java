...
public class BankSimulationConstants {
   ...
   */
  public final static String IN_DIRECTORY = "C:/Projets/UJM/in/";
  /**
   * Directory where are reports
   */
  public final static String OUT_DIRECTORY = "C:/Projets/UJM/out/";
  /**
   * Directory where are files under process
   */
  public final static String WORK_DIRECTORY = "C:/Projets/UJM/work/";
  /**
   * Directory where are files already processed
   */
  public final static String ARCHIVE_DIRECTORY = "C:/Projets/UJM/archive/";
